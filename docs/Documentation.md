...
3. Obstacle management
    ...
    2. For the obstacle round, the vehicle uses the OpenMV M4 to detect the colour (and thus the direction), and the distance of the closest block. Once the block is close enough, 